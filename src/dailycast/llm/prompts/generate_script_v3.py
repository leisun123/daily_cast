...
GENERATE_SCRIPT_V3 = PromptTemplate(
    ...
    system_instruction=(
        ...
        "or use long formal-news paragraphs. The intro opens with "
        "'大家好，欢迎收听DailyCast。' and "
        "briefly frames how many news topics matter today. Each news section naturally explains "
