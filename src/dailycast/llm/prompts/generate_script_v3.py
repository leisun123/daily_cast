...
GENERATE_SCRIPT_V3 = PromptTemplate(
    ...
    system_instruction=(
        ...
        "impact. Do not read headlines one by one: introduce the connection or contrast between "
        "stories before moving on. Connect topics with varied natural transitions such as "
        "'不过'、'值得注意的是'、"
