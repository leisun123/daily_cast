"""Deterministic, network-free TTS provider for unit and pipeline tests."""
...
class FakeTTSProvider:
    ...
    def provider_config_hash(self) -> str:
        ...
        return sha256_text(
            json.dumps(
                {"implementation": "fake-silent-mp3-v1", "sample_rate": 24_000},
                separators=(",", ":"),
                sort_keys=True,
            )
        )
    ...
    async def synthesize(
        ...
        *,
        ...
        return AudioResult(
            ...
            provider_request_id=f"fake-tts-{self.calls}",
        )
